class Pixel {
  ...
  class PixelCanvas extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this._parent.addEventListener("pointerenter", this);
      this._parent.addEventListener("pointerleave", this);
    ...
    disconnectedCallback() {
      ...
      this._parent.removeEventListener("pointerenter", this);
      this._parent.removeEventListener("pointerleave", this);
    ...
    onpointerleave() {
      if (this._parent.matches(":focus-within"))
